...
.initial_scroll_y: 		DB	 	A1_L1_INITIAL_SCROLL_Y  ; SCENE_STARTING_SCREEN_SCROLL_Y
.initial_scroll_x:		DB 		A1_L1_INITIAL_SCROLL_X	; SCENE_STARTING_SCREEN_SCROLL_X
...
.tilemap:				DW_BE 	act_1_scene_1_tilemap				; SCENE_TILEMAP ; Se almacen como HIGH/LOW
.goal_y: 				DB 		0						; SCENE_GOAL_POINT_X
.goal_x:				DB 		0						; SCENE_GOAL_POINT_Y
.next_scene:			DW_BE 	act_1_scene_2					; SCENE_NEXT_SCENE
...
.intro_scene:			DW_BE	act_1_scene_1_dialog_write 	; SCENE_INTRO_DIALOG