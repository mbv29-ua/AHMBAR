...
.tilemap:				DW_BE 	act_1_scene_3_tilemap				; SCENE_TILEMAP ; Se almacen como HIGH/LOW
.goal_y: 				DB 		0						; SCENE_GOAL_POINT_X
.goal_x:				DB 		0						; SCENE_GOAL_POINT_Y
.next_scene:			DW_BE 	act_1_scene_4			; SCENE_NEXT_SCENE
...
.intro_scene:			DW_BE	act_1_scene_3_dialog_write ; SCENE_INTRO_DIALOG