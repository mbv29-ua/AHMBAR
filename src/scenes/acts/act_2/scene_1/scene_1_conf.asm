...
.initial_scroll_y: 		DB	 	A2_L1_INITIAL_SCROLL_Y	; SCENE_STARTING_SCREEN_SCROLL_Y
.initial_scroll_x:		DB 		A2_L1_INITIAL_SCROLL_X	; SCENE_STARTING_SCREEN_SCROLL_X
...
.scene_collectible_spawner: DW_BE	init_ambars_act_2_scene_1					; SCENE_COLLECTIBLE_SPAWNER
...
.intro_scene:			DW_BE	act_2_scene_1_intro_dialog ; SCENE_INTRO_DIALOG