...
.tilemap:				DW_BE 	act_2_scene_3_tilemap	; SCENE_TILEMAP ; Se almacen como HIGH/LOW
.goal_y: 				DB 		0						; SCENE_GOAL_POINT_X
.goal_x:				DB 		0						; SCENE_GOAL_POINT_Y
.next_scene:			DW_BE 	act_2_scene_4			; SCENE_NEXT_SCENE
.scene_enemy_spawner:	DW_BE 	act_2_scene_3_enemy_spawner	; SCENE_ENEMY_SPAWNER
.scene_collectible_spawner: DW_BE	init_ambars_level3					; SCENE_COLLECTIBLE_SPAWNER
...
.intro_scene:			DW_BE	act_2_scene_3_intro_dialog ; SCENE_INTRO_DIALOG