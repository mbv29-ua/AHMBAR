...
SECTION "Act 3 Scene 1 configuration", ROM0
...
.scene_enemy_spawner:	DW_BE 	act_3_scene_1_enemy_spawner	; SCENE_ENEMY_SPAWNER
.scene_collectible_spawner: DW_BE	init_ambar_ac3_level1	; SCENE_COLLECTIBLE_SPAWNER
...
.intro_scene:			DW_BE	act_3_scene_1_dialog_write ; SCENE_INTRO_DIALOG