...
.starting_y: 			DB 		$88 				; SCENE_PLAYER_STARTING_Y
.starting_x: 			DB 		$90					; SCENE_PLAYER_STARTING_X
.initial_scroll_y: 		DB	 	112 					; SCENE_STARTING_SCREEN_SCROLL_Y
.initial_scroll_x:		DB 		$60						; SCENE_STARTING_SCREEN_SCROLL_X
...
.intro_scene:			DW_BE	act_3_scene_3_dialog_write ; SCENE_INTRO_DIALOG