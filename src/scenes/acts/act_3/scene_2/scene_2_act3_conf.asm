...
SECTION "Act 3 Scene 2 configuration", ROM0
...
.music:                 DW_BE   act_3_music             ; SCENE_MUSIC
.next_scene:			DW_BE 	act_3_scene_3			; SCENE_NEXT_SCENE
.scene_enemy_spawner:	DW_BE 	act_3_scene_2_enemy_spawner	; SCENE_ENEMY_SPAWNER
.scene_collectible_spawner: DW_BE	init_ambars_act3_level2	; SCENE_COLLECTIBLE_SPAWNER
...
.intro_scene:			DW_BE	act_3_scene_2_dialog_write ; SCENE_INTRO_DIALOG